...
NCountry = {
	...
	RESISTANCE_STRENGTH_FROM_UNIT = 0.100,			-- How much strength ticking speed is reduced from each unit in state (multiplies subunit value resistance_suppress)
...
NMilitary = {
	...
	RIVER_CROSSING_PENALTY_LARGE = -0.25,           -- large river crossing
